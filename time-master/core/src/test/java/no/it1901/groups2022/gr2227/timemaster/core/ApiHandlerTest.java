...
public class ApiHandlerTest {
  ...
  private static int STATUSCREATED = 201;

  @BeforeEach
  public void createApiHandler() {
    apiHandler = new ApiHandler();
    testEmployee1 = new Employee("Anna");
    this.wireMockServer = new WireMockServer(); // Listens to port 8080
  ...
  public void testGetEmployee() throws IOException {
    ...
    assertEquals(testEmployee1.getId(), apiHandler.getEmployee(testEmployee1).getId());
  }
